...
1. Fork in GitHub https://github.com/atsign-company/certinfo-action
2. Clone *your forked repository* (e.g., `git clone git@github.com:yourname/certinfo-action`)
3. Set your remotes as follows:

   ```sh
   cd certinfo-action
   git remote add upstream git@github.com:atsign-company/certinfo-action.git
   ...
   ```text
   origin  git@github.com:yourname/certinfo-action.git (fetch)
   origin  git@github.com:yourname/certinfo-action.git (push)
   upstream        git@github.com:atsign-company/certinfo-action.git (fetch)
